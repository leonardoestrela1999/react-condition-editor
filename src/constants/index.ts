...
export const OPERATORS_WITH_VALUE = [
  "equals",
  "greater_than",
  "less_than",
  "in",
...
export const OPERATORS_FOR_STRINGS = [
  "equals",
  "any",
  "none",
  "in",
...
export const OPERATORS_FOR_NUMBERS = [
  "equals",
  "greater_than",
  "less_than",
  "any",
...
export const OPERATORS_FOR_ENUMERATORS = ["equals", "any", "none", "in"];
